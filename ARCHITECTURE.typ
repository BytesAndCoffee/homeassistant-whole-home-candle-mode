#set page(width: 8.5in, height: 11in, margin: 0.7in)
...
#align(center)[
  #table(
    ...
    inset: 10pt,
    stroke: 0.6pt + gray,
    [*Virtual switch* \ Whole Home Candle Mode],
    [*input_boolean* \ `candle_mode_whole_room = on`],
    [*Starter automation* \ fans out in parallel],
    [*One script runner per lamp* \ independent bounded random walk],
    [*Lamp updates* \ brightness, kelvin, transition, delay],
  )
]
